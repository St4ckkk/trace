          ...
          <div class="row align-items-center">
                <form method="post" action="" class="form login">
                    <div class="input-group mb-3">
                        <input type="email" class="form-control form-control-lg bg-light fs-6" name="mailconnect" placeholder="Email address">
                    </div>
                    <div class="input-group mb-1">
                        <input type="password" class="form-control form-control-lg bg-light fs-6" name="mdpconnect" placeholder="Password">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <button class="btn btn-lg btn-primary w-100 fs-6" type="submit" name="formconnexion">Login</button>
                    </div>
